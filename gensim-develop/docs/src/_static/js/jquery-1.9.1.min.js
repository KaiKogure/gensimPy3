...
(function (e, t) {
        ...
        if (b.acceptData(e)) {
            ...
            if (s[u]) {
                if (t && (o = n ? s[u] : s[u].data)) {
                    b.isArray(t) ? t = t.concat(b.map(t, b.camelCase, c)) : t in o ? t = [t] : (t = b.camelCase(t), t = t in o ? [t] : t.split(" "));
    ...
    b.fn.extend({attr: function (e, t) {
        ...
        var n, r, i, o = this[0];
        {
            if (arguments.length)return i = b.isFunction(e), this.each(function (n) {
                ...
                1 === this.nodeType && (o = i ? e.call(this, n, a.val()) : e, null == o ? o = "" : "number" == typeof o ? o += "" : b.isArray(o) && (o = b.map(o, function (e) {
                    return null == e ? "" : e + ""
                }, c)), r = b.valHooks[this.type] || b.valHooks[this.nodeName.toLowerCase()], r && "set"in r && r.set(this, o, "value") !== t || (this.value = o))
            }, b);
        ...
        }, b), n.length || (e.selectedIndex = -1), n
    }}}, attr: function (e, n, r) {
    ...
    }, b)), b.support.hrefNormalized || (b.each(["href", "src", "width", "height"], function (e, n) {
        b.attrHooks[n] = b.extend(b.attrHooks[n], {get: function (e) {
            var r = e.getAttribute(n, 2);
            return null == r ? t : r
        }})
    }, b), b.each(["href", "src"], function (e, t) {
        b.propHooks[t] = {get: function (e) {
            return e.getAttribute(t, 4)
        }}
    }, b)), b.support.style || (b.attrHooks.style = {get: function (e) {
    ...
    }, b), b.each(["radio", "checkbox"], function () {
    ...
    }, b), b.support.submitBubbles || (b.event.special.submit = {setup: function () {
    ...
    }, b), b.fn.extend({on: function (e, n, r, i, o) {
        var a, s;
        if ("object" == typeof e) {
    ...
    }, b), b.extend({filter: function (e, t, n) {
    ...
    At.optgroup = At.option, At.tbody = At.tfoot = At.colgroup = At.caption = At.thead, At.th = At.td, b.fn.extend({text: function (e) {
        ...
        if (p && (l = b.buildFragment(e, this[0].ownerDocument, !1, this), i = l.firstChild, 1 === l.childNodes.length && (l = i), i)) {
            for (n = n && b.nodeName(i, "tr"), s = b.map(Ot(l, "script"), Ht, c), a = s.length; p > c; c++)o = l, c !== h && (o = b.clone(o, !0, !0), a && b.merge(s, Ot(o, "script"))), r.call(n && b.nodeName(this[c], "table") ? Lt(this[c], "tbody") : this[c], o, c);
            if (a)for (u = s[s.length - 1].ownerDocument, b.map(s, qt, c), c = 0; a > c; c++)o = s[c], kt.test(o.type || "") && !b._data(o, "globalEval") && b.contains(u, o) && (o.src ? b.ajax({url: o.src, type: "GET", dataType: "script", async: !1, global: !1, "throws": !0}) : b.globalEval((o.text || o.textContent || o.innerHTML || "").replace(St, "")));
            l = i = null
        }
        return this
    }});
    ...
    }, b), b.support.opacity || (b.cssHooks.opacity = {get: function (e, t) {
    ...
    b.fn.extend({serialize: function () {
        ...
        return this.map(function () {
            ...
            return this.name && !b(this).is(":disabled") && hn.test(this.nodeName) && !dn.test(e) && (this.checked || !Nt.test(e))
                ...
                }, c) : {name: t.name, value: n.replace(fn, "\r\n")}
            },function (a, c) {
                return{name: b.name, value: a.replace(bF, "\r\n")}
            }, c).get()
        ...
        }, b); else for (r in e)gn(r, e[r], n, o);
    ...
    function gn(e, t, n, r) {
        ...
        }, b); else if (n || "object" !== b.type(t))r(e, t); else for (i in t)gn(e + "[" + i + "]", t[i], n, r)
    }
    ...
    b.Tween = rr, rr.prototype = {constructor: rr, init: function (e, t, n, r, i, o) {
        ...
        return e && e.get ? e.get(this, b, c, "script") : rr.propHooks._default.get(this, b, c, "script")
    }, run: function (e) {
    ...
    }, b), b.fn.extend({fadeTo: function (e, t, n, r) {
        ...
        return a.finish = a, i || o.queue === !1 ? this.each(a, b) : this.queue(o.queue, a)
    }, stop: function (e, n, r) {
        var i = function (e) {
            var t = e.stop;
            delete e.stop, t(r)
    ...
    }, b), e.jQuery = e.$ = b, "function" == typeof define && define.amd && define.amd.jQuery && define("jquery", [], function () {
        return b
    })
})(window);