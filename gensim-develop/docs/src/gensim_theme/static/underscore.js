...
(function () {
    ...
    var m = typeof StopIteration !== "undefined" ? StopIteration : "__break__";
    var b = j._ = function (a) {
        return new i(a)
    };
    ...
    b.map = function (a, c, d) {
        if (a && b.isFunction(a.map))return a.map(c, d, c);
        var e = [];
    ...
    b.sortBy = function (a, c, d) {
        return b.pluck(b.map(a,function (e, f, g) {
