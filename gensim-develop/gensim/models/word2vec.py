        ...
        for sentence_no, sentence in enumerate(sentences):
            if sentence_no % 100 == 0:
                ...
                logger.info("PROGRESS: at sentence #%i, %.2f%% words, alpha %f, %.0f words per second" %
                            (sentence_no, 100.0 * word_count / total_words, alpha,
            ...
            if line.startswith(': '):
                ...
                try:
                    a, b, c, expected = [word.lower() for word in
                                         line.split()]  # TODO assumes vocabulary uses lowercase, too...
                except:
