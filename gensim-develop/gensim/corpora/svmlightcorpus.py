...
class SvmLightCorpus(IndexedCorpus):
    ...
    @staticmethod
    def save_corpus(fname, corpus, labels=False):
        """
    ...
    def line2doc(self, line):
        ...
        doc = [(int(p1) - 1, float(p2)) for p1, p2 in fields if
               p1 != 'qid'] # ignore 'qid' features, convert 1-based feature ids to 0-based
        return doc
